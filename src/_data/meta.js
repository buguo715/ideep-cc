export const url = process.env.URL || 'https://ideep.cc';
// Extract domain from `url`
export const domain = new URL(url).hostname;
export const siteName = 'ideep.cc';
...
export const author = {
  name: 'bu guo', // i.e. Lene Saile - page / blog author's name. Must be set.
  avatar: '/icon-512x512.png', // path to the author's avatar. In this case just using a favicon.
  email: 'buguo715@126.com', // i.e. hola@lenesaile.com - email of the author
  website: 'https://www.ideep.cc', // i.e. https.://www.lenesaile.com - the personal site of the author
...
export const creator = {
  name: 'bu guo', // i.e. Lene Saile - creator's (developer) name.
  email: 'hola@lenesaile.com',
  website: 'https://www.ideep.cc',
